        ...
        <div class="modal-body pt-0">
          ...
          <div class="content-area mx-auto">
            ...
            <div class="content-row">
              <div class="content-label">정의</div>
              <div class="content-box">{{ term.definition }}</div>
            </div>

            <!-- 주의 -->
            <div class="content-row mt-3">
              <div class="content-label">주의</div>
              <div class="content-box">{{ term.warning }}</div>
            </div>

            <!-- 예시 -->
            <div class="content-row mt-3">
              <div class="content-label">예시</div>
              <div class="content-box">{{ term.example }}</div>
            </div>
          </div>
        </div>
      </div>
